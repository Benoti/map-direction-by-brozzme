(function ($) {
 	...
 	$('.cmb-type-pw_map').each(function() {
		var searchInput = $('#store_adresse', this).get(0);
		...
		google.maps.event.addListener(autocomplete, 'place_changed', function() {
            ...
            // alert("hello " + addressType_route + " !");

            document.getElementById('store_adresse[completed_adresse]').value = addressType_street_number + ", " + addressType_route+ "  "+ addressType_postal_code+ "  "+addressType_locality;
